...
public interface ScheduleSeatRepository extends JpaRepository<ScheduleSeat, String> {
        ...
        @Modifying
        @Transactional
        @Query("DELETE FROM ScheduleSeat ss WHERE ss.movieId = :movieId AND ss.cinemaRoomId = :roomId AND ss.showDateId = :showDateId")
        void deleteByMovieIdAndCinemaRoomIdAndShowDateId(@Param("movieId") String movieId,
