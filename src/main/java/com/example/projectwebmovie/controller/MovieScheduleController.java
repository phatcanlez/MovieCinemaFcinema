...
public class MovieScheduleController {
    ...
    @ResponseBody
    public List<MovieScheduleForShowToAdminDTO> getSchedules(
            @RequestParam("cinemaRoomId") Integer cinemaRoomId,
            @RequestParam("showDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate showDate) {
        return movieScheduleService.getSchedulesByRoomAndDate(cinemaRoomId, showDate);
    }
}
