...
public interface SeatRepository extends JpaRepository<Seat, Integer> {
    ...
    /**
     * Tìm tất cả ghế đang hoạt động trong một phòng chiếu cụ thể, sắp xếp theo hàng và cột.
     *
     * @param roomId ID của phòng chiếu
     * @return danh sách các ghế đang hoạt động trong phòng chiếu, sắp xếp theo hàng và cột
     */
