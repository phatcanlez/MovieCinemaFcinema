...
public class MoMoPaymentController {
    ...
    @ResponseBody
    public String handleMoMoNotify(@RequestBody MoMoCallbackRequest callbackRequest) {
    ...
    private MoMoCallbackRequest extractCallbackRequest(HttpServletRequest request) {
        return MoMoCallbackRequest.builder()
                ...
                .extraData(request.getParameter("extraData") != null ?
                        request.getParameter("extraData") : "")
