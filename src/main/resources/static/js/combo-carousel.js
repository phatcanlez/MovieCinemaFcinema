            ...
            ${chunk.map((combo, index) => {
              ...
              return `
                <div class="col-lg-4 col-md-6">
                  <div class="combo-card ${combo.comboStatus === 'HOT' ? 'combo-popular' : ''} fade-in-up" style="animation-delay: ${animationDelay}s">
                    ${badgeText ? `
                    ...
                    <div class="combo-content">
                      <h4 class="combo-title">${combo.comboName}</h4>
                      <p class="combo-description">${combo.description}</p>
                      <div class="combo-pricing">
                        ${combo.discountPercentage > 0 ? `
                          <span class="original-price">${combo.formattedPrice}đ</span>
                          <span class="discounted-price">${combo.formattedDiscountedPrice}đ</span>
                        ` : `
                          <span class="current-price">${combo.formattedDiscountedPrice}đ</span>
                        `}
                      </div>
                    </div>
                  </div>
