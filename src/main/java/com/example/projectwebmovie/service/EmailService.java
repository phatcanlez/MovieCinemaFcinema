...
public class EmailService {
    ...
    public void sendPaymentConfirmationEmail(String customerEmail, Booking booking) {
        try {
            ...
            String htmlContent = loadPaymentConfirmationTemplate(customerName, booking, payment, seatInfo, comboInfo);
     ...
     */
    private String loadPaymentConfirmationTemplate(String customerName, Booking booking, Payment payment,
